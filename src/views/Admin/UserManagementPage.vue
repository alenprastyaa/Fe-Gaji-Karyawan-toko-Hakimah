...
<template>
  <div class="p-4 bg-white rounded-lg shadow-md">
    ...
    <div v-if="userStore.loading" class="text-center py-8">
      ...
      <div
        class="animate-spin rounded-full h-10 w-10 border-b-2 border-blue-500 mx-auto mt-4"
      ></div>
    </div>
    ...
    <div v-else>
      <div v-if="userStore.users.length > 0">
                ...
                >
                  ...
                  <td class="py-4 px-6 text-center">
                    <div class="flex items-center justify-center space-x-2">
                      ...
                      <button
                        @click="handleDeleteUser(user.id, user.namaLengkap)"
        ...
        <div class="lg:hidden space-y-4">
          ...
          >
            <!-- Header Card dengan Avatar dan Nomor -->
