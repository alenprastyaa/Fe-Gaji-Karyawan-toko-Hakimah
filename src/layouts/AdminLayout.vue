...
<template>
  <div class="min-h-screen flex flex-col bg-white">
    <nav
      class="bg-white backdrop-blur-xl border-b border-white/20 sticky top-0 z-50 shadow-lg shadow-purple-500/10"
    >
          ...
          <div class="hidden md:flex items-center space-x-8">
            <div class="flex items-center space-x-6">
              ...
              >
                Dashboard
                <span
                  class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-600 to-indigo-600 group-hover:w-full transition-all duration-300"
                ></span>
              </router-link>
              <router-link
                to="/admin/users"
    ...
    <footer
      class="bg-white/50 backdrop-blur-sm border-t border-white/20 text-gray-600 text-center py-6"
    >
      <div class="container mx-auto px-4">
        <p class="text-sm font-medium">
          &copy; 2025
          <span
            class="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent font-semibold"
          >
